...
hs <- makeParamSet( 
  ...
  makeIntegerParam("min_data_in_leaf",   lower= 4000L    , upper= 8000L), # 100 - 2000
  ...
  makeNumericParam("bagging_fraction", lower= 0.0001, upper=    1) ,# 0,5-1 default 
...
ksemilla_azar  <- 799949 #Aqui poner la propia semilla
#------------------------------------------------------------------------------
