...
karch_dataset    <- "./datasets/datasets_dataset_epic_v951_0010.csv.gz"

kapply_mes       <- c(202001)  #El mes donde debo aplicar el modelo

ktest_mes_hasta  <- 201911  #Esto es lo que uso para testing
ktest_mes_desde  <- 201911

ktrain_subsampling  <- 0.1   #el undersampling que voy a hacer de los continua

ktrain_mes_hasta    <- 201910  #Obviamente, solo puedo entrenar hasta 202011
ktrain_mes_desde    <- 201901
ktrain_meses_malos  <- c( 202006 )  #meses que quiero excluir del entrenamiento


kgen_mes_hasta    <- 201911   #La generacion final para Kaggle, sin undersampling
