...
kscript         <- "962_epic_5015_18"

karch_dataset    <- "./datasets/dataset_epic_v951_0010.csv.gz"

kapply_mes       <- c(201901)  #El mes donde debo aplicar el modelo

ktest_mes_hasta  <- 201811  #Esto es lo que uso para testing
ktest_mes_desde  <- 201811
...
kgen_mes_hasta    <- 201811   #La generacion final para Kaggle, sin undersampling
