...
kscript         <- "992_epic"
karch_dataset   <- "./datasets/dataset_epic_simple_v009.csv.gz"   #el dataset que voy a utilizar
#karch_dataset <- karch_dataset[karch_dataset$foto_mes=202009]
karch_realidad  <- "./datasets/dataset_epic_simple_v009.csv.gz" #el dataset que voy a utilizar
#karch_realidad  <- karch_realidad[karch_realidad$foto_mes=202011]
...
kgen_mes_desde   <- 202009  #desde donde voy a entrenar
...
drealidad   <- drealidad [drealidad $foto_mes=="202011"]
